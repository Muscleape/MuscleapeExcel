...
import com.muscleape.excel.parameter.GenerateParam;
import com.muscleape.excel.support.ExcelTypeEnum;
import com.muscleape.excel.write.ExcelBuilder;
import com.muscleape.excel.write.ExcelBuilderImpl;
...
public class ExcelWriter {
     ...
     */
    public ExcelWriter write(List<? extends BaseRowModel> data, MuscleapeSheet sheet) {
    ...
    public ExcelWriter write(List data) {
        if (objectClass != null) {
            return this.write(data,new MuscleapeSheet(1,0,objectClass));
        }else {
            return this.write0(data,new MuscleapeSheet(1,0,objectClass));
     ...
     * @return this
     */
    public ExcelWriter write1(List<List<Object>> data, MuscleapeSheet sheet) {
        excelBuilder.addContent(data, sheet);
        return this;
    }
     ...
     * @return this
     */
    public ExcelWriter write0(List<List<String>> data, MuscleapeSheet sheet) {
        excelBuilder.addContent(data, sheet);
        return this;
    }
     ...
     * @return this
     */
    public ExcelWriter write(List<? extends BaseRowModel> data, MuscleapeSheet sheet, MuscleapeTable table) {
     ...
     * @return this
     */
    public ExcelWriter write0(List<List<String>> data, MuscleapeSheet sheet, MuscleapeTable table) {
        excelBuilder.addContent(data, sheet, table);
        return this;
    }
     ...
     * @return
     */
    public ExcelWriter write1(List<List<Object>> data, MuscleapeSheet sheet, MuscleapeTable table) {
        excelBuilder.addContent(data, sheet, table);
        return this;
    }
