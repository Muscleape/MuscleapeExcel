 ...
 * @author Muscleape
 */
public class MuscleapeExcelFactory {
     ...
     */
    public static List<Object> read(InputStream in, MuscleapeSheet sheet) {
     ...
     */
    public static void readBySax(InputStream in, MuscleapeSheet sheet, AnalysisEventListener listener) {
     ...
     * @return com.muscleape.excel.ExcelWriter
     * @author Muscleape
     * @date 2019/4/27 14:41
     */
    public static ExcelWriter getWriter(OutputStream outputStream, ExcelTypeEnum excelTypeEnum) {
        return new ExcelWriter(outputStream, excelTypeEnum, true);
    }
     ...
     * @return new  ExcelWriter
     */
    public static ExcelWriter getWriterWithTempAndHandler(InputStream temp, OutputStream outputStream, ExcelTypeEnum typeEnum,
                                                          boolean needHead, WriteHandler handler) {
