package com.muscleape.excel.analysis.v03;
...
public class XlsSaxAnalyser extends BaseSaxAnalyser implements HSSFListener {
    ...
    private List<MuscleapeSheet> sheets = new ArrayList<>();
    ...
    public void processRecord(Record record) {
        ...
        switch (record.getSid()) {
            ...
            case BOFRecord.sid:
                ...
                if (br.getType() == BOFRecord.TYPE_WORKSHEET) {
                    ...
                    MuscleapeSheet sheet = new MuscleapeSheet(sheetIndex, 0);
        ...
        if (record instanceof LastCellOfRowDummyRecord) {
            ...
            MuscleapeSheet sheet = analysisContext.getCurrentSheet();
